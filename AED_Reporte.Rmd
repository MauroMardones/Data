---
title: "Informe autocontenido Análisis Exploratorio de Datos Monitoreo de la pesquería Bacalao de profundidad APA"
...
kbl(landing, booktabs = T,format = "latex",
...
kbl(resultados, booktabs = T,format = "latex",
...
```{r warning=FALSE, message=F, fig.height=6, fig.width=8}
